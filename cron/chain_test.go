...
func (j *countJob) ID() string                   { return "" }
func (j *countJob) Next(now time.Time) time.Time { return time.Time{} }

func (j *countJob) EndTime() time.Time { return time.Date(9999, 1, 1, 0, 0, 0, 0, time.Local) }
